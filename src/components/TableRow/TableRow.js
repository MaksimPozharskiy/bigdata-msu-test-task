...
function TableRow({id, urlPoster, title, year, rating, runtime, defaultComment, setIsVisiblePopup}) {
  ...
  return (
    <tr className='table__body-row'>
      ...
      {defaultComment ? 'comment' : 
        <>
          <svg onClick={hadleAddButton} className='table__add-icon' xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="40px" viewBox="0 0 24 24" width="40px" fill="#000000">
