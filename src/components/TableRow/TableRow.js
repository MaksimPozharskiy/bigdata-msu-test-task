  ...
  return (
    <tr className='table__body-row'>
      ...
      {defaultComment ? 'comment' : 
        <>
          {comment.length > 0 ? 
            <svg onClick={() => hadleDeleteCommentButton(id)} className='table__add-icon table__add-icon_delete' xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 0 24 24" width="40px" fill="#000000">
            ...
            : 
            <svg onClick={hadleAddCommentButton} className='table__add-icon table__add-icon_add' xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="40px" viewBox="0 0 24 24" width="40px" fill="#000000">
